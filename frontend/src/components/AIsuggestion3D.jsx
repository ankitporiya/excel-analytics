  ...
  const setFallback3DSuggestions = () => {
    ...
    if (numericColumns.length > 0 && categoricalColumns.length > 0) {
      fallback.push({
        ...
        zAxis: null,
        reason:
          "3D bars provide enhanced visual depth for comparing categories",
        confidence: "medium",
    ...
    if (numericColumns.length >= 3) {
      fallback.push({
        ...
        reason:
          "Perfect for exploring relationships in three-dimensional space",
        confidence: "high",
  ...
  return (
    <div className="relative">
      ...
      <motion.button
        ...
        className="mb-4 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-300 text-sm sm:text-base font-semibold shadow-lg flex items-center gap-2"
        whileHover={{
          scale: 1.05,
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            className="bg-gradient-to-br from-[#f8fff8] via-[#e6f3e6] to-[#f0f8f0] rounded-xl shadow-lg border border-green-200 overflow-hidden"
          ...
          >
            ...
            <motion.div
              className="bg-gradient-to-r from-green-600 to-green-700 p-4 sm:p-6"
            ...
            <div className="p-4 sm:p-6">
                ...
                {!GEMINI_API_KEY && (
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        <strong>3D AI features disabled:</strong> Please set
                        your VITE_GEMINI_API_KEY in your environment variables
                        to enable 3D AI suggestions.
                      </span>
                    </motion.p>
                  </motion.div>
                )}
              ...
              <AnimatePresence>
                {suggestions.length > 0 && (
                  ...
                  >
                    <motion.h4
                      className="text-lg sm:text-xl font-semibold text-green-600 mb-3 sm:mb-4 flex items-center gap-2"
                      whileHover={{ x: 5 }}
                      transition={{ duration: 0.2 }}
                    >
                      <motion.span
                    ...
                    {loading ? (
                      ...
                      >
                        <motion.div
                          className="rounded-full h-8 w-8 border-4 border-green-600 border-t-transparent"
                      ...
                      >
                        {suggestions.map((suggestion, index) => (
                          <motion.div
                            key={index}
                            className="bg-white rounded-lg border-2 border-green-200 hover:border-green-400 transition-all duration-300 cursor-pointer overflow-hidden"
                              ...
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div className="flex-1 min-w-0">
                                  ...
                                  {suggestion.visualBenefit && (
                                    <motion.div
                                      className="text-xs sm:text-sm text-green-700 bg-green-50 px-2 py-1 rounded-md inline-block"
                                      initial={{ opacity: 0 }}
                                      animate={{ opacity: 1 }}
                                      transition={{ delay: 0.4 }}
                                    >
                                      <strong>3D Benefit:</strong>{" "}
                                      {suggestion.visualBenefit}
                                    </motion.div>
                                  )}
                                </div>
                                ...
                                <motion.button
                                  className="ml-0 sm:ml-4 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-300 text-sm sm:text-base font-semibold shadow-lg self-start sm:self-center"
                                  whileHover={{
                                    scale: 1.05,
                                    boxShadow:
              ...
              <AnimatePresence>
                {loading && !suggestions.length && (
                  ...
                  >
                    <motion.div
                      className="inline-block rounded-full h-10 w-10 sm:h-12 sm:w-12 border-4 border-green-600 border-t-transparent mb-4"
                      variants={loadingVariants}
                      animate="spin"
                    />
                    <motion.p
              ...
              <motion.div
                className="mt-6 p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <ul className="text-xs text-green-600 space-y-1">
                  ...
                  <li>
                    • Better understanding of multi-dimensional relationships
                  </li>
