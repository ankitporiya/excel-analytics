            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-4" style={{ backgroundColor: "#fff" }}>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center">
                    <div className="text-2xl mb-2" style={{ color: "#bde8f1" }}>📊</div>
                    <p className="text-sm" style={{ color: "#819fa7" }}>Storage Efficiency</p>
                  ...
                  <div className="text-center">
                    <div className="text-2xl mb-2" style={{ color: "#bde8f1" }}>🔄</div>
                    <p className="text-sm" style={{ color: "#819fa7" }}>Last Updated</p>
                    <p className="font-semibold" style={{ color: "#0d0d0d" }}>
                  ...
                  <div className="text-center">
                    <div className="text-2xl mb-2" style={{ color: "#bde8f1" }}>⚡</div>
                    <p className="text-sm" style={{ color: "#819fa7" }}>Status</p>
                    <p className="font-semibold" style={{ color: "#0d0d0d" }}>Active</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-4" style={{ backgroundColor: "#fff" }}>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span style={{ color: "#819fa7" }}>Small Files (&lt; 1MB):</span>
                    <span className="font-semibold" style={{ color: "#0d0d0d" }}>
                      {storageData.fileCount > 0 ? Math.ceil(storageData.fileCount * 0.3) : 0} files
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span style={{ color: "#819fa7" }}>Medium Files (1-5MB):</span>
                    <span className="font-semibold" style={{ color: "#0d0d0d" }}>
                      {storageData.fileCount > 0 ? Math.ceil(storageData.fileCount * 0.5) : 0} files
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span style={{ color: "#819fa7" }}>Large Files (&gt; 5MB):</span>
                    <span className="font-semibold" style={{ color: "#0d0d0d" }}>
