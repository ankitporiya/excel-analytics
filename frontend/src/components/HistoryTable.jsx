...
const HistoryTable = ({
  ...
  const handleDeleteChart = async (chart) => {
    ...
    const isConfirmed = window.confirm(
      `Are you sure you want to delete "${chart.chartName}"? This action cannot be undone.`
    );
    if (!isConfirmed) {
      return;
    }
    ...
    try {
      ...
      const errorMessage =
        error.message || "Failed to delete chart. Please try again.";
