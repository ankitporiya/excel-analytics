...
//       setShowChart(false); // Hide previous chart when new file is selected
//       setChartConfig((prev) => ({ ...prev, xAxis: "", yAxis: "" })); // Reset axis selection
//       // console.log(getFileData(selectedFileId))
//     }
//   }, [selectedFileId, dispatch]);
...
//                   className="w-full px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-200 flex items-center justify-center space-x-2"
//                 >
//                   <span>🤖</span>
//                   <span>{showAIPanel ? 'Hide AI Assistant' : 'Show AI Assistant'}</span>
//                 </button>
//               </div>
...
//                     <span>Bar charts work best for categorical comparisons</span>
//                   </li>
//                   <li className="flex items-start space-x-2">
...
//                     <span>Scatter plots reveal relationships between variables</span>
//                   </li>
//                   <li className="flex items-start space-x-2">
...
//                   {chartTypes.map((type) => (
//                     <div key={type.value} className="flex items-center space-x-3 p-2 bg-gray-50 rounded-lg">
//                       <span className="text-lg">{type.icon}</span>
//                       <div>
//                         <p className="font-medium text-gray-800">{type.label}</p>
//                         <p className="text-gray-600 text-xs">
//                           {type.value === 'bar' && 'Compare categories side by side'}
//                           {type.value === 'line' && 'Show trends over time'}
//                           {type.value === 'pie' && 'Display proportions of a whole'}
//                           {type.value === 'scatter' && 'Reveal correlations between variables'}
//                           {type.value === 'column3d' && 'Enhanced visual impact for comparisons'}
//                         </p>
//                       </div>
//                     </div>
//                   ))}
...
const ChartPage = () => {
  ...
  const handleAISuggestion = (suggestion) => {
    ...
    // Show a brief notification
    const notification = document.createElement('div');
    notification.className = 'fixed top-4 right-4 bg-[#228B22] text-white px-4 py-2 rounded-lg shadow-lg z-50';
    notification.textContent = '✨ AI suggestion applied!';
    document.body.appendChild(notification);
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            >
              ...
              {fileLoading ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  <p className="text-lg">No Excel files found.</p>
                  <p className="text-sm sm:text-base">Please upload some Excel files first to create charts.</p>
                </div>
              ) : (
                <div>
                  <select
                  ...
                  <div className="text-center">
                    ...
                    >
                      {chartLoading ? (
                        ...
                        <span className="flex items-center justify-center">🎨 Create Chart</span>
                      )}
                    </motion.button>
