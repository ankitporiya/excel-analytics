  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at ${mousePosition.x * 0.1}% ${mousePosition.y * 0.1}%, rgba(34, 139, 34, 0.08) 0%, transparent 50%),
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              right: '20%',
              top: '20%',
              background: 'conic-gradient(from 0deg, #228B22 0deg, #32CD32 120deg, #90EE90 240deg, #228B22 360deg)',
              borderRadius: '50%',
          ...
          <div
            ...
            style={{
              ...
              clipPath: 'polygon(10% 100%, 20% 85%, 30% 90%, 40% 75%, 50% 80%, 60% 65%, 70% 70%, 80% 55%, 90% 60%, 100% 45%, 100% 100%)',
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 relative z-10">
          ...
          >
            {[
              { icon: "📊", title: "Data Visualization", desc: "Create stunning charts and graphs from your Excel data", delay: "0s" },
              { icon: "🤖", title: "AI Insights", desc: "Get intelligent analysis and recommendations", delay: "0.2s" },
              { icon: "📈", title: "Advanced Analytics", desc: "Perform complex data analysis with ease", delay: "0.4s" }
            ].map((feature, index) => (
              <div
                key={index}
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = "rgba(189, 232, 241, 0.4)";
                  e.currentTarget.style.transform = "scale(1.05) translateY(-10px)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = "rgba(189, 232, 241, 0.2)";
              ...
              >
                <div 
                  ...
                  style={{ filter: 'drop-shadow(0 4px 8px rgba(34,139,34,0.1))' }}
                >
                  {feature.icon}
                </div>
                <h3
